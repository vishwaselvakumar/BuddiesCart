...
const Testimonials = () => {
  ...
  <div className="max-w-2xl mx-auto text-center">
    ...
    <p className="text-sm mt-4 leading-relaxed text-gray-800">
      Veniam proident aute magna anim excepteur et ex consectetur velit ullamco
      veniam minim aute sit. Elit occaecat officia et laboris Lorem minim.
      Officia do aliqua adipisicing ullamco in
    </p>
  </div>
...
{/* <section className="bg-[#a8dadc] dark:bg-blue">
...
<div className="px-10 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 dark:text-gray-100">
  <h2 className="mb-8 text-4xl font-bold leading-none text-center text-white">
    What do we have to offer?
  </h2>
  <ul className="grid gap-3 md:grid-cols-2 lg:grid-cols-3 text-white">
