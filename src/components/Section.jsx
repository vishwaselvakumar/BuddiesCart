    ...
    <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
        ...
        >
          ...
          <h2 className="mt-2 font-bold">  Web Design and Development
          </h2>

          <p className="hidden sm:mt-1 sm:block sm:text-sm sm:text-gray-600">
          Custom website design tailored to your brand identity.
Responsive and mobile-friendly layouts for seamless browsing on any device.<br/>
Advanced development on platforms like WordPress, Shopify, Magento, and custom solutions.
Secure and scalable websites with optimized performance.
E-commerce store development and maintenance.
        ...
        >
          ...
          <h2 className="mt-2 font-bold">  Search Engine Optimization (SEO)
          </h2>
...
On-page optimization to improve content, metadata, and structure.
Off-page SEO, including backlink building and authority development.
Local SEO to attract customers in your area.
Regular reporting and analytics to measure your progress.
        ...
        >
          ...
          <h2 className="mt-2 font-bold">  Social Media Optimization (SMO)</h2>

          <p className="hidden sm:mt-1 sm:block sm:text-sm sm:text-gray-600">
          Profile setup and optimization for all major social networks.
Strategic content creation to drive engagement.
Regular posting and audience interaction to build relationships.
Analytics and reporting to track performance and ROI.
