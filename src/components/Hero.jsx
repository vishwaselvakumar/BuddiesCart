...
<section
  className="bg-white  mt-[130px] overflow-x-hidden mb-10" 
  id="saheel"
>
  <div className="grid max-w-screen-xl w-full px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-4 lg:grid-cols-12">
    <div className="mr-auto place-self-center lg:col-span-7">
      ...
      <h1 className="max-w-[80%] sm:max-w-[60%] lg:max-w-[80%] mb-4 mx-auto text-center lg:text-left text-3xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl ">
        <span className="whitespace-nowrap">
          <span className="text-[#12b5d8]">E-commerce</span><br /> Excellence!
        </span>
      </h1>
      <p className="max-w-[70%] sm:max-w-[60%] mb-5 lg:max-w-[80%] mx-auto text-center lg:text-left font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl ">
        At BuddiesCart, we do more than offer e-commerce services — we become your growth partner. From launching your store to scaling it to new heights, we craft innovative solutions that make your brand shine in the competitive digital marketplace.
      </p>
      <div className="flex flex-wrap justify-center lg:justify-center gap-6">
        <Link to="/contact"
          
          className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 "
        >
          Get started
          <svg
            className="w-5 h-5 ml-2 -mr-1"
...
<div className="mt-2 mb-10">
      ...
      <div className="p-5 lg:p-18 bg-gradient-to-bl from-neutral-800 via-neutral-900 to-neutral-950 rounded-xl">
        <div className="grid grid-cols-1 sm:grid-cols-3 items-center gap-y-20 gap-x-12 m-2">
          ...
          <div className="relative text-center">
            ...
            <div className="mt-3 sm:mt-5">
              <h3 className="text-lg sm:text-3xl font-semibold text-white">
                <CountUp end={55000000} duration={8} prefix="$" separator="," />
                +
              </h3>
              <p className="mt-1 text-sm sm:text-base text-neutral-400">
                Ads managed yearly
  ...
  Customizing the content or features of a document, website, or product?
  Creating tailored text, designs, or configurations?
  Developing instructions or a template for customization?
  Are you looking for added features, sections, or personalization ideas?
  Do you need templates, examples, or explanations for specific concepts?
  </p>
  <div className="flex justify-center items-center">
    <Link to="/contact">
    <button
      type="button"
      className="px-6 py-2 mt-8 rounded text-white text-sm tracking-wider font-medium outline-none border-2 border-blue-600 bg-[#12B5D8] hover:bg-transparent hover:text-black transition-all duration-300"
    >
      Read More
    </button>
    </Link>
      ...
      <div className="max-md:order-1 p-5">
        ...
        Delivering consistent results through dedication, efficiency, and skill, driving team and organizational success.
        Optimized for speed, reliability, and scalability, ensuring seamless user experiences under all conditions.
        A flawless blend of creativity and precision, captivating audiences and achieving the desired impact.
        </p>
        <div className="flex items-center justify-center">
          <Link to="/contact">
        <button
